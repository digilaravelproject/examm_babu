...
@section('head')
    <meta http-equiv="refresh" content="1;url={{ url('/student/exams') }}" />
@endsection
...
<script>
        // 2 seconds (2000 milliseconds) ka delay
        setTimeout(function() {
            // Yahan wo URL dalein jahan redirect karna hai
            window.location.href = "{{ url('/student/exams') }}";
        }, 1000);
    </script>
@endsection
