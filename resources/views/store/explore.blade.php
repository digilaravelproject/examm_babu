@php
    $lightNavbar = true; // Hero section dark hai, isliye navbar light text wala chahiye
@endphp
            ...
            @if ($plans->count() > 0)
                <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    @foreach ($plans as $plan)
                        ...
                        @php
                            // 1. Database Price is the MRP (Original Price)
                            ...
                            $sellingPrice = $originalPrice; // Default
                            $savings = 0;

                            if ($hasDiscount) {
                                // Formula: Selling = MRP - (MRP * Discount / 100)
                        ...
                        <div class="relative flex flex-col h-full overflow-hidden transition-all duration-300 bg-white border border-slate-200 rounded-2xl hover:shadow-xl hover:shadow-blue-900/5 hover:-translate-y-1 hover:border-blue-300 group">
                            ...
                            <div class="p-5 mt-auto">
                                {{-- Check Logic: Admin Disabled vs Student Active --}}
