...
<head>
        ...
        tailwind.config = {
            theme: {
                extend: {
                    colors: {
                        brand: {
                            blue: 'var(--brand-blue)',   // #0777be
                            pink: 'var(--brand-pink)',   // #f062a4
                            green: 'var(--brand-green)', // #94c940
                            sky: 'var(--brand-sky)',     // #7fd2ea
                            sidebar: 'var(--sidebar-bg)' // #0f172a
                        }
                    }
                }
            }
    ...
    <style>
        ...
        body {
            ...
            overflow-x: hidden;
            background-color: #f8fafc; /* Matches Login Page */
        }
        ...
        .bullet-tag {
            ...
            font-weight: 600;
            color: #ffffff;
            /* Green accent border from variables */
    ...
    <div class="relative z-10 flex flex-row w-full max-w-4xl overflow-hidden bg-white border border-gray-100 shadow-2xl animate-card rounded-2xl"
        ...
        <div class="relative flex-col justify-center hidden p-8 overflow-hidden md:flex md:w-1/2 bg-brand-blue lg:p-12">
            ...
            <div class="relative z-20">
                <h2 class="mb-4 text-xs font-bold tracking-widest uppercase text-brand-sky">JOIN EXAMBABU</h2>
            ...
            <div class="absolute bottom-0 left-0 w-full pointer-events-none h-28 bg-gradient-to-t from-brand-sidebar/50 to-transparent">
            </div>
        </div>
        ...
        <div class="relative flex flex-col justify-center w-full p-6 bg-white md:w-1/2 lg:p-10">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-3">
                ...
                <div class="flex gap-3">
                    <div class="w-1/2">
                        <label class="block text-[11px] font-bold text-gray-700 mb-1 uppercase tracking-wide">First Name</label>
                    ...
                    <div class="w-1/2">
                        <label class="block text-[11px] font-bold text-gray-700 mb-1 uppercase tracking-wide">Last Name</label>
                ...
                <div x-data="{
                    ...
                    <label class="block text-[11px] font-bold text-gray-700 mb-1 uppercase tracking-wide">Username</label>
                    <div class="relative">
                ...
                <div>
                    <label class="block text-[11px] font-bold text-gray-700 mb-1 uppercase tracking-wide">Email Address</label>
                ...
                <div x-data="{ show: false }">
                    <label class="block text-[11px] font-bold text-gray-700 mb-1 uppercase tracking-wide">Password</label>
                    <div class="relative">
                ...
                <div x-data="{ showConfirm: false }">
                    <label class="block text-[11px] font-bold text-gray-700 mb-1 uppercase tracking-wide">Confirm Password</label>
                    <div class="relative">
                ...
                <div class="pt-2">
                    <button type="submit"
                        class="w-full flex justify-center py-3 px-4 border border-transparent rounded-xl text-sm font-bold text-white bg-brand-blue hover:bg-brand-sidebar focus:ring-2 focus:ring-offset-2 focus:ring-brand-blue transition-all shadow-lg shadow-blue-200 transform hover:-translate-y-0.5">
                        Create Account
                    </button>
                </div>
                ...
                <div class="mt-3 text-center">
                    <p class="text-xs text-gray-500">
                        ...
                        <a href="{{ route('login') }}" class="font-bold transition-colors text-brand-blue hover:text-brand-pink">Log In</a>
                    </p>
                </div>
            </form>
        </div>
