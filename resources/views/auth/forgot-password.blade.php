...
<head>
    ...
    <title>Forgot Password - ExamBabu</title>
    ...
    <div class="animate-card w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-row border border-blue-100 relative z-10"
        ...
        <div class="hidden md:flex md:w-1/2 bg-brand-blue relative flex-col justify-center p-8 lg:p-12 overflow-hidden">
            ...
            <div class="relative z-20">
                <h2 class="text-xs font-bold text-blue-100 uppercase tracking-widest mb-4">ACCOUNT RECOVERY</h2>
                <h1 class="text-3xl font-bold text-white mb-3 leading-tight"
                    style="font-family: 'Playfair Display', serif;">Don't Worry, <br>We Got You</h1>
                <p class="text-sm text-blue-100 italic mb-8 leading-relaxed">It happens to the best of us. Reset your
                    password and get back to your studies in no time.</p>

                <div class="flex flex-wrap flex-col items-start">
                    <span class="bullet-tag">🔒 Secure Reset Process</span>
                    <span class="bullet-tag">📧 Check Your Email</span>
                    <span class="bullet-tag">⚡ Fast & Easy Recovery</span>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('password.email') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="email" name="email" :value="old('email')" required autofocus
                        class="block w-full px-4 py-2.5 rounded-lg bg-gray-50 border border-gray-200 text-gray-900 text-sm focus:bg-white focus:ring-2 focus:ring-brand-blue focus:border-transparent outline-none transition-all shadow-sm placeholder-gray-400"
                ...
                <div class="text-center mt-4">
                    <a href="{{ route('login') }}"
                        class="inline-flex items-center text-sm font-semibold text-gray-500 hover:text-brand-blue transition-colors">
