                    ...
                    <div>
                        ...
                        <select name="model_name" id="model_name" onchange="checkCustomModel(this.value)"
                            ...
                            <optgroup label="Gemini 2.0 (Latest)">
                                <option value="gemini-2.0-flash" {{ $settings->model_name == 'gemini-2.0-flash' ? 'selected' : '' }}>Gemini 2.0 Flash (Fastest)</option>
                                <option value="gemini-2.0-flash-lite-preview-02-05" {{ $settings->model_name == 'gemini-2.0-flash-lite-preview-02-05' ? 'selected' : '' }}>Gemini 2.0 Flash-Lite</option>
                                <option value="gemini-2.0-pro-exp-02-05" {{ $settings->model_name == 'gemini-2.0-pro-exp-02-05' ? 'selected' : '' }}>Gemini 2.0 Pro Experimental</option>
                                <option value="gemini-2.0-flash-exp" {{ $settings->model_name == 'gemini-2.0-flash-exp' ? 'selected' : '' }}>Gemini 2.0 Flash Exp</option>
                            </optgroup>
                            <optgroup label="Gemini 1.5">
                                <option value="gemini-1.5-flash" {{ $settings->model_name == 'gemini-1.5-flash' ? 'selected' : '' }}>Gemini 1.5 Flash (Recommended)</option>
                                <option value="gemini-1.5-flash-8b" {{ $settings->model_name == 'gemini-1.5-flash-8b' ? 'selected' : '' }}>Gemini 1.5 Flash-8B</option>
                                <option value="gemini-1.5-pro" {{ $settings->model_name == 'gemini-1.5-pro' ? 'selected' : '' }}>Gemini 1.5 Pro (Powerful)</option>
                            </optgroup>
                            <optgroup label="Gemini 1.0">
                                <option value="gemini-1.0-pro" {{ $settings->model_name == 'gemini-1.0-pro' ? 'selected' : '' }}>Gemini 1.0 Pro</option>
                            </optgroup>
