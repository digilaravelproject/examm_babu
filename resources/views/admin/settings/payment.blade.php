        ...
        <div class="p-4 mt-5 border border-amber-200 rounded-lg bg-amber-50">
            <div class="flex gap-3">
                ...
                <div class="text-sm text-amber-800">
                    ...
                    <p class="mt-1 text-amber-700">If you see this error during payment, go to <strong>Razorpay Dashboard → Settings → Website & App Details</strong> and ensure your website domain (e.g. <code class="px-1 bg-amber-100 rounded">{{ request()->getHost() }}</code>) is listed in the <em>"Website"</em> field.</p>
                </div>
            </div>
        </div>
        </div>
