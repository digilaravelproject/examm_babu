                ...
                @forelse($exams as $exam)
                    <tr class="transition-colors hover:bg-gray-50/80 group">
                        ...
                        <td class="px-5 py-4 text-center">
                            @if ($exam->is_active)
                                <span
                                    class="inline-flex items-center rounded-md px-2.5 py-1 text-xs font-bold ring-1 ring-inset ring-opacity-30"
                                    style="background-color: rgba(148, 201, 64, 0.1); color: var(--brand-green); --tw-ring-color: var(--brand-green);">
                                    <span class="w-1.5 h-1.5 mr-1.5 rounded-full"
                                        style="background-color: var(--brand-green);"></span>
                                    Active
                                </span>
                            @else
                                <span
                                    class="inline-flex items-center rounded-md bg-gray-50 px-2.5 py-1 text-xs font-bold text-gray-500 ring-1 ring-inset ring-gray-500/20">
