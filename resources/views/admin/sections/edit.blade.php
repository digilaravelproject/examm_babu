...
@php
    ...
    // Merge ID
    $updateParams = array_merge($params, ['section' => $section->id]);
@endphp
...
<div class="py-6 mx-auto space-y-6 max-w-7xl">
    <div class="flex items-center justify-between px-4 sm:px-0">
        <div>
            ...
            <p class="text-sm text-gray-500">Editing: <span class="font-mono text-[#f062a4] font-bold">{{ $section->name }}</span></p>
        </div>
    ...
    @include('admin.sections.partials._form', [
        'section' => $section,
        'action' => route($routePrefix . 'sections.update', $updateParams),
        'method' => 'PUT'
    ])
</div>
@endsection
