...
<div class="max-w-full">
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <div class="text-sm text-gray-500">New Exam</div>
        </div>
    ...
    <div class="bg-white p-4 rounded shadow mb-6">
        <div class="flex items-center justify-between">
            <div>
                <div class="text-lg font-semibold">Exam Details</div>
                <div class="text-sm text-gray-500">New Exam</div>
            </div>
            ...
            <div class="flex gap-3">
                ...
                <button class="px-4 py-2 border rounded text-sm bg-gray-100 text-gray-700">2 Sections</button>
        ...
        <form action="#" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea rows="8" class="mt-2 block w-full border border-gray-200 rounded px-3 py-2" placeholder="Write exam description here..."></textarea>
                </div>
