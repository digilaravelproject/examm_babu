            ...
            <table class="min-w-full">
                <thead>
                    <tr class="text-left text-sm text-gray-600">
                        ...
                        <th class="py-3 px-4">SECTIONS</th>	
                    ...
                    <tr class="bg-gray-50">
                        <form method="GET" action="{{ route('admin.exam.index') ?? route('admin.quizzes.index') }}">
                            ...
                            <th class="py-3 px-4">
                                <select name="visibility" class="w-full px-3 py-2 border rounded text-sm bg-white">
                                    <option value="">All</option>
                            ...
                            <th class="py-3 px-4 text-right">
                                <div class="flex justify-end gap-2">
                                    ...
                                    <a href="{{ route('admin.exam.index') ?? route('admin.quizzes.index') }}" class="px-3 py-2 border rounded text-sm">Reset</a>
                                </div>
                            </th>
                        </form>
                    </tr>
                ...
                <tbody class="divide-y">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="py-6 px-4 text-center text-gray-500">No exams found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
