...
@php
    ...
    // Merge ID for update route
    $updateParams = array_merge($params, ['micro_category' => $microCategory->id]);
@endphp
...
<div class="py-6 mx-auto space-y-6 max-w-7xl">
    <div class="flex items-center justify-between px-4 sm:px-0">
        <div>
            ...
            <p class="text-sm text-gray-500">Editing: <span class="font-mono text-[#f062a4] font-bold">{{ $microCategory->name }}</span></p>
        </div>
    ...
    @include('admin.micro_categories.partials._form', [
        ...
        'action' => route($routePrefix . 'micro-categories.update', $updateParams),
        'method' => 'PUT'
    ])
</div>
@endsection
