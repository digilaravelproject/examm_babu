...
@php
    ...
    $urlIndex = route($routePrefix . 'skills.index', $params);
    $urlCreate = route($routePrefix . 'skills.create', $params);
@endphp
...
@section('content')
    ...
    <div x-data="skillManagement('{{ $urlIndex }}')" x-init="init()" class="space-y-6">
        ...
        <div x-show="!loading" id="table-container">
            @include('admin.skills.partials.table', [
...
@push('scripts')
    ...
    <script>
        function skillManagement(baseUrl) {
            return {
                search: '',
                status: '',
                section_id: '',
