...
<div class="max-w-full">
    ...
    <div class="flex items-center justify-between mb-6">
        <h3 class="text-2xl font-semibold text-gray-800">Exam Types</h3>
                    ...
                    <tr class="bg-gray-50">
                        <form method="GET">
                            ...
                            <th class="py-3 px-4 text-right">
                                ...
                                <a href="{{ route('admin.exam-types.index') }}" class="px-3 py-2 border rounded text-sm">Reset</a>
                            </th>
                        </form>
                    </tr>
                </thead>
