...
<div class="py-6 mx-auto space-y-6 max-w-7xl">
    <div class="flex items-center justify-between px-4 sm:px-0">
        ...
        <a href="{{ route($routePrefix . 'categories.index', $params) }}"
    ...
    @include('admin.categories.partials._form', ['category' => new \App\Models\Category(), 'routePrefix' => $routePrefix, 'routeParams' => $params])
</div>
@endsection
