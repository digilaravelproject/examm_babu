...
@section('header', 'Create Practice Sets')
...
<div class="max-w-full">
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h3 class="text-2xl font-semibold text-gray-800">Practice Sets Details</h3>
            <div class="text-sm text-gray-500">New Practice Sets</div>
        </div>
    ...
    <div class="bg-white p-4 rounded shadow mb-6">
        <div class="flex items-center justify-between">
            <div>
                <div class="text-lg font-semibold">Practice Sets Details</div>
                <div class="text-sm text-gray-500">New Practice Sets</div>
            </div>
        ...
        <form action="#" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Skill <span class="text-red-500">*</span></label>
