    ...
    <div class="flex min-h-screen" x-data="{ sidebarOpen: false }">
        ...
        <aside class="flex-shrink-0 hidden w-64 min-h-screen text-white bg-gray-800 md:block">
            ...
            <div class="flex items-center gap-3 p-4 border-b border-gray-700">
                <img src="{{ asset('assets/images/logo.png') }}" alt="Exam Babu"
                    class="object-contain h-10 ml-2 rounded-sm w-25">
            </div>
            ...
            <nav class="px-2 mt-4">
                ...
                <div x-data="{ open: {{ request()->routeIs('admin.tests.*', 'admin.quizzes.*', 'admin.exams.*', 'admin.quiztypes.*', 'admin.examtypes.*') ? 'true' : 'false' }} }" class="relative">
                    <button @click="open = !open" type="button"
                        ...
                        <svg :class="open ? 'transform rotate-180' : ''" class="w-4 h-4 text-gray-300"
                    ...
                    <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-150"
                        ...
                        x-transition:leave-end="opacity-0 -translate-y-1" class="mt-1" style="margin-left: 20%;">
                ...
                <div x-data="{ open: {{ request()->routeIs('admin.practice-sets.*', 'admin.lessons.*', 'admin.videos.*') ? 'true' : 'false' }} }" class="relative">
                    <button @click="open = !open" type="button"
                        class="w-full flex items-center justify-between py-2.5 px-4 rounded hover:bg-gray-700 mt-1
                ...
                <div class="relative" x-data="{ dropdownOpen: false }">
                    ...
                    <div x-show="dropdownOpen" @click.away="dropdownOpen = false"
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit"
                                class="block w-full px-4 py-2 text-sm text-left text-gray-700 hover:bg-gray-100">Log
                                Out</button>
                        </form>
                    </div>
                </div>
