...
<body class="h-full font-sans antialiased text-slate-900 bg-slate-50"
      x-data="{
          ...
          init() {
              {{--
              // Commented out Syllabus Fetch Logic
  ...
  @php
    ...
    <div class="fixed top-0 left-0 right-0 z-[9999] bg-red-600 text-white text-center px-4 py-2 shadow-md flex items-center justify-center gap-4">
                    ...
                    <div class="relative" x-data="{ dropdownOpen: false }">
                        <button @click="dropdownOpen = !dropdownOpen" class="flex items-center space-x-3 focus:outline-none group">
                            ...
                            <div class="hidden text-left md:block">
                                ...
                                <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wider">{{ Auth::user()->roles->first()->fullname ?? 'Student' }}</p>
                            </div>
                        ...
                        <div x-show="dropdownOpen" @click.away="dropdownOpen = false" x-cloak
                            ...
                            <div class="px-5 py-4 border-b bg-slate-50 border-slate-100">
                                <p class="text-sm font-bold truncate text-slate-900">{{ Auth::user()->fullname }}</p>
