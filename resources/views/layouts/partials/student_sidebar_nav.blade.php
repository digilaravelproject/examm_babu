...
<div class="space-y-1.5">
    ...
    <a href="{{ route('student.dashboard') }}"
        ...
        <svg class="w-5 h-5 mr-3 {{ request()->routeIs('student.dashboard') ? 'text-white' : 'text-slate-400' }}"
    ...
    <a href="{{ route('student.exams.dashboard') }}"
        ...
        <svg class="w-5 h-5 mr-3 {{ request()->routeIs('student.exams.dashboard') || request()->routeIs('student.exams.type') ? 'text-white' : 'text-slate-400' }}"
            fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <a href="{{ route('student.exams.topic-wise') }}"
        class="flex items-center px-3 py-3 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('student.exams.topic-wise') ? 'bg-[var(--brand-blue)] text-white shadow-md' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}">
        {{-- Icon: Stack/Collection (Best for Topics) --}}
        <svg class="w-5 h-5 mr-3 {{ request()->routeIs('student.exams.topic-wise') ? 'text-white' : 'text-slate-400' }}"
            fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <a href="{{ route('student.exams.live') }}"
        ...
        <svg class="w-5 h-5 mr-3 {{ request()->routeIs('student.exams.live') ? 'text-white' : 'text-slate-400' }}"
            fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <a href="{{ route('student.add_exams') }}"
        ...
        <svg class="w-5 h-5 mr-3 {{ request()->routeIs('student.add_exams') ? 'text-white' : 'text-slate-400' }}"
            fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <a href="{{ route('student.subscriptions.index') }}"
        ...
        <svg class="w-5 h-5 mr-3 {{ request()->routeIs('student.subscriptions.*') ? 'text-white' : 'text-slate-400' }}"
            fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <a href="{{ route('student.payments.index') }}"
        ...
        <svg class="w-5 h-5 mr-3 {{ request()->routeIs('student.payments.*') ? 'text-white' : 'text-slate-400' }}"
            fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    {{-- Refer & Earn (Permission Based) --}}
    @can('access referral')
        <a href="{{ Route::has('panel.referral.dashboard') ? route('panel.referral.dashboard', ['role' => $currentRole]) : '#' }}"
            class="flex items-center px-3 py-3 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('referral.*') ? 'bg-[var(--brand-blue)] text-white shadow-md' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}">
            <svg class="w-5 h-5 mr-3 {{ request()->routeIs('referral.*') ? 'text-white' : 'text-slate-400' }}"
                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
