...
{
/** @use HasFactory<\Database\Factories\SubCategoryFactory> */    use HasFactory;
    use Sluggable;
    use SoftDeletes;
    use SecureDeletes;
    use LogsActivity;
...
/**
    ...
    // ✅ SAHI: Sirf Fillable rakhein, guarded ko hata dein.
    protected $fillable = [
        'category_id',
    ...
    // Isko 'boolean' rehne de sakte hain, kyunki ab hum Blade aur Controller me sambhal rahe hain.
    ...
    */
    ...
    {
        return $this->hasMany(MicroCategory::class, 'sub_category_id');
    }
}
