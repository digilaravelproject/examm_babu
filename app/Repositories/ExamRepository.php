...
class ExamRepository
{
    public function getSteps($eId = null, $active = 'details')
    {
        return [
            ...
            ['step' => 4, 'key' => 'questions', 'title' => 'Questions', 'status' => $active == 'questions' ? 'active' : 'inactive', 'url' => $eId ? route('admin.exams.questions.index', $eId) : ''], // Question controller route placeholder
